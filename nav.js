...
(function(){
  ...
  const BLOCKS = [
    ...
    { id: 'brand', emoji: '🎙️', name: 'Marca & Marketing', color: '#7C3AED', docs: [
      ...
      { n: '27', t: 'Visual Identity',        f: '27-visual-identity.html',  s: 'pending' },
    ]},
    { id: 'legal', emoji: '⚖️', name: 'Legal & Compliance', color: '#EF4444', docs: [
      { n: '28', t: 'Terms of Service',       f: '28-terms-of-service.html', s: 'pending' },
      { n: '29', t: 'Privacy + Cookies',      f: '29-privacy-policy.html',   s: 'pending' },
      { n: '30', t: 'Templates legales',      f: '30-templates-legal.html',  s: 'pending' },
    ]},
    { id: 'sec', emoji: '⛨', name: 'Seguridad', color: '#3B82F6', docs: [
      { n: '31', t: 'Security Policy',        f: '31-security-policy.html',  s: 'pending' },
      { n: '32', t: 'Incident Response',      f: '32-incident-response.html',s: 'pending' },
    ]},
    { id: 'gov', emoji: '👔', name: 'Gobernanza & Ops', color: '#94A3B8', docs: [
      { n: '33', t: 'PRD Template',           f: '33-prd-template.html',     s: 'pending' },
      { n: '34', t: 'OKRs Framework',         f: '34-okrs.html',             s: 'pending' },
      { n: '35', t: 'Risk Register',          f: '35-risk-register.html',    s: 'pending' },
      { n: '36', t: 'RACI Matrix',            f: '36-raci-matrix.html',      s: 'pending' },
      { n: '37', t: 'Runbook + DR',           f: '37-runbook.html',          s: 'pending' },
      { n: '38', t: 'Onboarding Dev',         f: '38-onboarding-dev.html',   s: 'pending' },
      { n: '39', t: 'API SDK + Postman',      f: '39-api-sdk.html',          s: 'pending' },
      { n: '40', t: 'Glosario',               f: '40-glosario.html',         s: 'pending' },
      { n: '41', t: 'Changelog',              f: '41-changelog.html',        s: 'pending' },
    ]},
  ];
